...
contract('MultiNumberBettingV7', function(accounts) {
  ...
  it("should assert true", function() {
    ...
    return MultiNumberBettingV7.deployed().then(function(instance){
      ...
      web3.eth.sendTransaction({from:bills_address,to:multi_number_betting_v7.address, value:sendValue});

      // #3
      // Send a winning/losing guess from Frank
      var sendValue = web3.utils.toWei('1','ether');
      ...
      console.log('Received Event: ',
                  ...
                  ', Bet Amount: ',
                  web3.utils.fromWei((result.logs[0].args.amount),'ether'), 'Ether');
    });
  });
});
