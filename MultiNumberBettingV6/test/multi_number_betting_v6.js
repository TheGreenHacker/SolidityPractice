...
contract('MultiNumberBettingV6', function(accounts) {
  ...
  it("should assert true", function() {
    ...
    return MultiNumberBettingV6.deployed().then(function(instance){
      ...
      // #2
      var sendValue = web3.utils.toWei('20','ether');
      ...
      console.log('John balance after initial send : ',web3.utils.fromWei(result,'ether'));
      
      return web3.eth.getBalance(multi_number_betting_v6.address);
    }).then(function(result){
      console.log('Contract balance after initial send : ',web3.utils.fromWei(result,'ether'));

      var receiveValue = web3.utils.toWei('2','ether');
      ...
      console.log("Johns final balance : ",web3.utils.fromWei(result,'ether'));
      // Now get the balance for Contract
      return web3.eth.getBalance(multi_number_betting_v6.address);
    }).then(function(result){
      console.log("Contracts final balance : ",web3.utils.fromWei(result,'ether'));
    });
  });
});
